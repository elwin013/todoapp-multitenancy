 ...
 */
package net.codeer.app.multiRowLevel.jooq.tables;
...
import net.codeer.app.multiRowLevel.jooq.Indexes;
import net.codeer.app.multiRowLevel.jooq.Keys;
import net.codeer.app.multiRowLevel.jooq.Public;
import net.codeer.app.multiRowLevel.jooq.tables.records.TodosRecord;
...
public class Todos extends TableImpl<TodosRecord> {
    ...
    /**
     * The column <code>public.todos.tenant_id</code>.
     */
    public final TableField<TodosRecord, Long> TENANT_ID = createField(DSL.name("tenant_id"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_TODO_CREATED, Indexes.IDX_TODO_CREATED_BY, Indexes.IDX_TODO_TENANT_ID);
    }
